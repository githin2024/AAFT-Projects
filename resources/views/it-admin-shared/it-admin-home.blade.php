            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped mt-4" id="intAdminCampaignTable" style="font-size: small">
                            <thead>
                            <tr>                                
        ...
        <div class="col-lg-6 col-md-6 mb-md-0 mb-4">
            <div class="card">
                ...
                <div class="col-md-12" style="height: 400px; padding-left: 18%;" id="lpCampaignChartDiv">
                    ...
                    <hr />
                    <div class="table-responsive">
                        <table class="table table-striped mt-4" id="intAdminLpCampaignTable" style="font-size: small">
                            <thead>
                            <tr>
...
<script src="https://cdn.tutorialjinni.com/notify/0.4.2/notify.min.js"></script>
    ...
    <script type="text/javascript">
        $(document).ready(function() {        
          ...
          $("#it-adminHomeID").addClass( "active bg-primary" );
          $("#it-adminCampaignFormID").removeClass("active bg-primary");
          $("#it-adminLandingPageID").removeClass("active bg-primary");
          $("#intAdminCampaignTable").dataTable();
          $("#intAdminLpCampaignTable").dataTable();
        });
        ...
        var atx = document.getElementById('lpCampaignChart').getContext('2d');
          ...
          $.ajax({
            type:'get',
            url: "/it-admin-home-change-institution",
            data: {'institution' : institute},          
            success:function(data){
              
              var campBody = $("#intAdminCampaignTable").empty();
              var lpBody = $("#intAdminLpCampaignTable").empty();
              ...
              $('#intAdminCampaignTable').DataTable().destroy();
              $("#intAdminCampaignTable").dataTable();
              $('#intAdminLpCampaignTable').DataTable().destroy();
              $("#intAdminLpCampaignTable").dataTable();
